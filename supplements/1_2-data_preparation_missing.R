...
main <- dat2[order(dat2$mergeid,dat2$wave),]
...
write.csv(base, "mypath/supplements/baseline_missing.csv", row.names = F)
write.csv(main, "mypath/supplements/main_missing.csv", row.names = F)
